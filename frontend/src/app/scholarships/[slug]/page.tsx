                    ...
                    <div className="lg:col-span-2">
                        <div className="space-y-6">
                            ...
                            <div className="prose prose-lg max-w-none">
                                <h2 className="mb-4 text-xl font-semibold">Deskripsi Beasiswa</h2>
                                <div
                        ...
                        <div className="space-y-6">
                            ...
                            <Card className="p-0">
                                <CardContent className="p-6">
                                    <h3 className="mb-4 text-lg font-semibold">Detail Beasiswa</h3>
                                    <div className="space-y-4">
                                        {/* Date & Time */}
                            ...
                            <Card className="p-0">
                                <CardContent className="p-6">
                                    <h3 className="mb-4 text-lg font-semibold">Penyedia Beasiswa</h3>

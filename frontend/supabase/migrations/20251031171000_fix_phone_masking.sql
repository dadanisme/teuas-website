-- Fix phone number masking function
-- The previous version had issues with country code handling
-- This corrects the DECLARE block placement
...
-- Update comment
COMMENT ON FUNCTION mask_phone_number(TEXT) IS 'Masks phone numbers with fixed-length mask (****) showing only last 3 digits - FIXED version';
...
BEGIN
  ...
  RAISE NOTICE '✅ All mask_phone_number tests passed successfully!';
END;
$$;
